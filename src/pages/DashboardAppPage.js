...
function applySortFilter(array, comparator, query) {
    ...
    if (query) {
        return filter(
            array,
            (_user) =>
                _user.client_name.toLowerCase().indexOf(query.toLowerCase()) !==
                -1
        );
    }
...
export default function DashboardAppPage() {
    ...
    const handleDialogData = (data) => {
        ...
        const index = updatedBudgets.findIndex(
            (budget) => budget.budget_id === data.budget_id
        );
                ...
                <>
                    ...
                    <Container>
                        ...
                        <Typography variant="body1" gutterBottom>
                            Your subscription has ended. Please renew your
                    ...
                    {isFirstCardOpen && (
                        ...
                        >
                            <CardContent>
                                ...
                                >
                                    See how VBudget helps video pros like you
                                    quickly develop prduction budgets
                                </Typography>
                                <div
                                    style={{
                                        marginTop: "10px",
                        ...
                        >
                            <CardContent>
                                ...
                                >
                                    ...
                                    >
                                        See how VBudget helps video pros like
                                        you quickly develop production budgets
                                    </Typography>
                                    <Button
                                        variant="contained"
                                        color="primary"
                    ...
                    <TableContainer sx={{ minWidth: 800 }}>
                        ...
                        <Link to={`/dashboard/budget-details/${budget_id}`}> */}
                                                <TableCell
                                                    ...
                                                    onClick={() => {
                                                        navigate(
                                                            `/dashboard/budget-details/${budget_id}`
                                                        );
                                                    }}
                                                    scope="row"
                                                    padding="none"
